  ...
  return (
    <div className="flex flex-wrap items-center gap-2 overflow-x-auto overflow-y-hidden px-0.5 pb-0.5 pt-px [scrollbar-width:thin] gap-2 pb-1">
      ...
      <div className="inline-flex flex-none items-center gap-1.5">
        ...
        <button className={clsx("inline-flex h-7 min-w-7 cursor-pointer items-center justify-center gap-1 rounded-[6px] border border-pos-line bg-pos-surface2 px-2 text-xs font-bold text-pos-ink transition-[border-color,color] hover:border-pos-primary hover:text-pos-primary disabled:cursor-not-allowed disabled:opacity-40 px-2.5", snap && "border-pos-primaryLine bg-pos-primarySoft text-pos-primary")} onClick={() => setSnap((s) => !s)}>
