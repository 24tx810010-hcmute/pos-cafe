...
function ClearDemoDialog({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div
      className="absolute inset-0 z-20 grid place-items-center bg-slate-900/50"
      onClick={(event) => {
