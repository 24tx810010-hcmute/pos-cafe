...
export function StorePairingScreen() {
  ...
  return (
    <main className="box-border grid min-h-[100dvh] w-full place-items-center overflow-y-auto overflow-x-hidden bg-pos-bg p-4" data-testid="store-pairing-screen">
