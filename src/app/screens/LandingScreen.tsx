...
export function LandingScreen() {
  ...
  return (
    <main className="grid h-screen w-screen place-items-center overflow-auto bg-pos-bg" data-testid="landing-screen">
      <div className="grid w-[min(960px,100%)] gap-7 px-[clamp(16px,4vw,48px)] py-[clamp(24px,5vw,64px)]">
        ...
        <div className="grid grid-cols-3 gap-3 border-t border-pos-line pt-5">
