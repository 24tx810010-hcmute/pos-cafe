...
export const mockFloorPlan: FloorPlan = {
  ...
  tables: [
    ...
    { id: "tbl-b02", areaId: "area-ground", name: "B02", backgroundAssetKey: "/floor-assets/tables/table-bg-02.png", posX: 500, posY: 190, width: 120, height: 76, shape: "rectangle", rotation: 0, seats: 4, sortOrder: 2, status: "occupied" },
    { id: "tbl-b03", areaId: "area-ground", name: "B03", backgroundAssetKey: "/floor-assets/tables/table-bg-03.png", posX: 750, posY: 190, width: 126, height: 76, shape: "rectangle", rotation: 0, seats: 4, sortOrder: 3, status: "occupied" },
    { id: "tbl-b04", areaId: "area-ground", name: "B04", backgroundAssetKey: "/floor-assets/tables/table-bg-04.png", posX: 1040, posY: 190, width: 120, height: 76, shape: "rectangle", rotation: 0, seats: 4, sortOrder: 4, status: "empty" },
    { id: "tbl-b05", areaId: "area-ground", name: "B05", backgroundAssetKey: "/floor-assets/tables/table-bg-05.png", posX: 300, posY: 520, width: 126, height: 84, shape: "rectangle", rotation: 0, seats: 4, sortOrder: 5, status: "occupied" },
    { id: "tbl-b06", areaId: "area-ground", name: "B06", backgroundAssetKey: "/floor-assets/tables/table-bg-06.png", posX: 600, posY: 520, width: 120, height: 76, shape: "rectangle", rotation: 0, seats: 4, sortOrder: 6, status: "empty" },
    { id: "tbl-b07", areaId: "area-ground", name: "B07", backgroundAssetKey: "/floor-assets/tables/table-bg-07.png", posX: 880, posY: 520, width: 120, height: 76, shape: "rectangle", rotation: 0, seats: 4, sortOrder: 7, status: "empty" },
    { id: "tbl-b08", areaId: "area-ground", name: "B08", backgroundAssetKey: "/floor-assets/tables/table-bg-08.png", posX: 1180, posY: 520, width: 126, height: 84, shape: "rectangle", rotation: 0, seats: 6, sortOrder: 8, status: "occupied" },
    { id: "tbl-l01", areaId: "area-first", name: "L01", backgroundAssetKey: "/floor-assets/tables/table-bg-09.png", posX: 260, posY: 190, width: 120, height: 76, shape: "rectangle", rotation: 0, seats: 4, sortOrder: 1, status: "empty" },
    { id: "tbl-l02", areaId: "area-first", name: "L02", backgroundAssetKey: "/floor-assets/tables/table-bg-10.png", posX: 500, posY: 190, width: 120, height: 76, shape: "rectangle", rotation: 0, seats: 4, sortOrder: 2, status: "empty" },
    { id: "tbl-l03", areaId: "area-first", name: "L03", backgroundAssetKey: "/floor-assets/tables/table-bg-11.png", posX: 750, posY: 190, width: 126, height: 76, shape: "rectangle", rotation: 0, seats: 4, sortOrder: 3, status: "empty" },
    { id: "tbl-l04", areaId: "area-first", name: "L04", backgroundAssetKey: null, posX: 1040, posY: 190, width: 120, height: 76, shape: "rectangle", rotation: 0, seats: 4, sortOrder: 4, status: "empty" },
    { id: "tbl-l05", areaId: "area-first", name: "L05", backgroundAssetKey: "/floor-assets/tables/table-bg-01.png", posX: 460, posY: 500, width: 126, height: 84, shape: "rectangle", rotation: 0, seats: 4, sortOrder: 5, status: "empty" },
    { id: "tbl-l06", areaId: "area-first", name: "L06", backgroundAssetKey: null, posX: 760, posY: 500, width: 126, height: 84, shape: "rectangle", rotation: 0, seats: 4, sortOrder: 6, status: "empty" },
  ],
  decorItems: [
