...
Ngày cập nhật: 2026-09-14. Change: `add-idempotent-write-operations`.
...
**Hậu kiểm ngày 2026-09-10:** review độc lập đã tìm F1–F5; kết luận nghiệm thu hoàn tất ở phần lịch sử bên dưới không còn là kết luận rollout hiện hành. Chủ dự án yêu cầu ưu tiên F1 cache Tra cứu giữa phiên, kèm test và hai reviewer độc lập. Theo dõi bản sửa và bằng chứng tại [khắc phục F1](phase-27-f1-recovery-cache-fix.md). Ngày2026-09-11, F2–F5 cùng generation guard đã được xử lý và chạy gate mới: [log khắc phục](phase-27-p2-fixes.md),1123passed/758required; chưa deploy migration014–016.
...
Tại mốc báo cáo trước hậu kiểm, triển khai và nghiệm thu code được ghi là hoàn tất. Kết luận rollout hiện hành đã được thay bởi thông báo hậu kiểm đầu tài liệu và log F1; các finding còn mở phải xử lý tiếp. Change được giữ tại đường dẫn hiện hành để tra cứu bộ spec đã duyệt; chưa archive/apply delta vào baseline specs trong lượt này. Trạng thái code đã push không đồng nghĩa migration đã chạy trên môi trường thật.
