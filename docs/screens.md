...
- **Primary actions:** add area/table/decor; kéo để di chuyển; dùng handle dưới object để resize/xoay; chỉnh layout trong inspector; delete soft, save, discard/confirm close.
- **Important states:** loading, empty floor, dirty new table, dirty confirm, object locked không cho transform trực tiếp, snap grid bật/tắt, save error.
