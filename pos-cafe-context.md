...
## Bước kế
DB/RPC foundation đã implement và local validate bằng PostgreSQL temp. Bước kế tiếp: Supabase Adapter Track (`src/adapters/supabase/*`). Không commit/push khi chưa có yêu cầu rõ.
