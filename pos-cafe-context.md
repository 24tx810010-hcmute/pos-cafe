...
## Bước kế
DB/RPC, Supabase adapter foundation và Store/Auth/Seed logic foundation đã implement/push trên code branch. Bước kế tiếp: Session D POS Order/Payment logic hooks/services, rồi mới bind UI thật từng màn. Không merge cho tới khi build/test/smoke xanh và user chốt.
