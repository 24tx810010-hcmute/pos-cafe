...
- **Đánh dấu một nhóm quyền là dành riêng cho chủ quán**, không gán được cho vai trò khác kể cả khi chủ muốn. Nhóm này gồm xóa toàn bộ dữ liệu. Cấp lại Store Key **không** nằm trong danh mục quyền hành động: theo quyết định 19 của `add-owner-account-and-store-provisioning`, thao tác đó chỉ thực hiện được từ mặt web của tài khoản chủ và được gác bằng mã một lần gửi qua email, không phải bằng quyền nhân viên.
